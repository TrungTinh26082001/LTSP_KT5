    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId())
        {
            case android.R.id.home:
                ...
                return true;
            case R.id.menu1:
                i = new Intent(MainActivity_KT4.this, TTSVMainActivity.class);
                startActivity(i);
...
//                break;
            case R.id.menu3:
                i = new Intent(MainActivity_KT4.this, MainActivity_KT3.class);
                startActivity(i);
                //code xử lý khi bấm menu3
                break;
            case R.id.menu4:
                i = new Intent(MainActivity_KT4.this, MainActivity_KT4.class);
                startActivity(i);
                //code xử lý khi bấm menu3
                break;
            default:break;
